...
@implementation UIViewController (XYNav)

+(void)load{
    
    [XYMethodHook instanceMethodExchangeOriginClass:self originMethod:@selector(viewWillAppear:) exchangeClass:self exchangeMethod:@selector(y_viewWillAppear:)];
    [XYMethodHook instanceMethodExchangeOriginClass:self originMethod:@selector(viewDidAppear:) exchangeClass:self exchangeMethod:@selector(y_viewDidAppear:)];
    [XYMethodHook instanceMethodExchangeOriginClass:self originMethod:@selector(viewDidLoad) exchangeClass:self exchangeMethod:@selector(y_viewDidLoad)];
}
